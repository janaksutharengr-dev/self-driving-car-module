function generateCarInspector(index) {
    ...
    miniMap = new MiniMap(c3, world.graph, mapSize - c3Margin * 2);
    ...
    if (rightBarWidth > 0) {
        ...
        document.getElementById("miniMapContainer").appendChild(c3);
    }
...
function changeTarget(el) {
    ...
    switch (el.value) {
        case "Wärtsilä":
            ...
            miniMap.img.src = "imgs/maps-and-flags.png";
